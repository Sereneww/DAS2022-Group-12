...
For this data set, it describe the situation that each animal admitted to the shelter. there are 7 variables contains which are xxxxxxxxx. 
this project aiming for determinatesXXXX(research question). 
method:
